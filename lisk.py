...
private_key = "Privat key"  # Ganti dengan private key dummy
my_address = Web3.to_checksum_address("Wallet addrs")  # Alamat dompet dummy
...
gas_price_wrap_gwei = 0.000001035  # Adjust as needed
gas_price_unwrap_gwei = 0.000001035  # Adjust as needed
